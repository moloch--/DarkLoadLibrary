...
UINT32 resolve_hash_name(LPCSTR cszName)
{
    ...
    SIZE_T uNameLen = strlen(cszName);
    if (uNameLen == 0)
    {
        return 0;
    }
...
BOOL resolve_find(PRESOLVE_ENTRY pEntry)
{
    ...
    {
        #ifdef DEBUG
        printf("Failed to find DOS_HEADER\n");
        #endif
        return FALSE;
    }
    ...
    {
        #ifdef DEBUG
        printf("IMAGE_NT_SIGNATURE mismatch\n");
        #endif
        return FALSE;
    }
    ...
    {
        #ifdef DEBUG
        printf("VirtualAddress or Size is 0\n");
        #endif
        return FALSE;
    }
    ...
    #ifdef DEBUG
    printf("Did not find hash in exports\n");
    #endif
    return FALSE;
}
